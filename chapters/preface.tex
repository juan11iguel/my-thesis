...
alternatives is evaluated for a commercial 50~MW$_\text{e}$ \gls{cspLabel}
plant, Andasol-II, located in southern Spain. Specifically, three cooling
systems, all modelled and validated, are compared: the plant's existing
...
refrigeración combinada novedosas. Con este fin, se evalúa el rendimiento anual
de diferentes alternativas de refrigeración para una planta comercial de
50~MW$_\text{e}$ \gls{cspLabel}, Andasol-II, ubicada en el sur de España. En
concreto, se comparan tres sistemas de refrigeración, todos ellos modelados y
validados: el sistema húmedo \gls{wctLabel} existente en la planta, y dos
variantes de un novedoso sistema de refrigeración combinada (\gls{ccLabel}) con
capacidades de enfriador seco del 75~\% y del 100~\% de la carga térmica nominal
del sistema \gls{wctLabel}. 
