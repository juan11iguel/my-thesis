...
As previously mentioned, \gls{cspLabel} plants are among the most
water-intensive power generation technologies, a concern that is especially
relevant in the arid regions where they are typically located. To assess the
performance ---water use and operational costs--- of different cooling systems,
the proposed methodology is applied to a real-world case study through an annual
simulation. The case study examined is the Andasol-II \gls{cspLabel} plant.
