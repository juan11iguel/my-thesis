...
\nrefsec{cc:fig:cc:optimization:environment}}. The first source is rainwater
...
A model of the Andasol-II plant, developed by Bartolomé et al.~\sidecite{ortegadelgado_theoretical_2016}, was
...
\begin{kaobox}[title=Simulation data and parameters information] 
    \begin{itemize}
        ...
        of Andasol-II CSP plant from a simulation model~\cite{ortegadelgado_theoretical_2016}.
...
\begin{marginfigure}[*-12]
    \includegraphics[]{figures/cc_year_analysis_composite_cooling_costs.png}
...
\begin{figure*}[h!]
    \includegraphics[width=1\linewidth]{figures/cc-simulation-annual-comparison.png}
