...
For every static optimization problem (referencias a problemas) four different
algorithms were tested: \gls{seaLabel}, \gls{ihsLabel} and \gls{decstrLabel}.
For each alternative the same number of objective function evaluations were
given, XX. For each alternative three options are tested with a different
population .... Table X shows the results obtained, in terms of fitness at
