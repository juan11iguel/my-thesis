...
\begin{figure*}
    \includegraphics[width=0.8\linewidth]{figures/cc-validation-samples_wct.png}
...
acumulado.\todo{La figura es provisional. Actualizar la figura con cambios mencionados}
...
Comentar la figura, sobre el frente de pareto que se muestra, cómo la estática
...
\textbf{Control layer}. Four controllers are implemented in this layer...
