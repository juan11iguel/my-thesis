...
\begin{table*}[htbp]
\caption[\gls{wctLabel} prediction results obtained with the different modelling
approaches studied]{Summary table of the \gls{wctLabel} prediction results
obtained with the different modelling approaches studied. \textbf{T} and
\textbf{V} stand for training and validation datasets, respectively.}
...
\begin{table*}[]
\caption[\gls{dcLabel} prediction results obtained with the different modelling
approaches studied]{Summary table of the \gls{dcLabel} prediction results
obtained with the different modelling approaches studied. \textbf{T} and
\textbf{V} stand for training and validation datasets, respectively.}
...
\nrefch{cc:optimization}. First, an optimization algorithm is chosen from the
...
\begin{itemize}
    ...
    \textit{Regulatory control} -- \textit{Cooling power}}.
