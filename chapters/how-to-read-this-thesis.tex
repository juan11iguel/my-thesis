...
of this thesis.\sidenote[{\color{gray} \faToiletPaper}]{Like hoarding toilet paper}.\todo{Esto debería ser un
icono de un rollo de papel higiénico, fijarse en template de cv para ver cómo añadirlos}
