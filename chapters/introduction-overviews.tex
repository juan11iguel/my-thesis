...
%===================================
%===================================
\section{(Pendiente mover) SolarMED pilot plant description}
...
\reffig{intro:desalination:solarmed-pilot-plant-diagram}: a flat plate
...
The combined cooling pilot plant at the Plataforma Solar de Almería (shown in
Figure \reffig{intro:cooling:cc-pilot-plant-diagram}) consists of three
circuits: cooling circuit, exchange circuit and heating circuit. In the cooling
circuit, water circulating inside the tube bundle of a surface condenser is
...
layout in \reffig{intro:cc:pilot-plant-pid}) consists of three circuits:
...
\reffig{intro:cc:pilot-plant-pid}). 
...
% \marginnote{
\begin{equation*}
    \mbox{R\gls{mseLabel}} = \sqrt{\frac{1}{n} \sum\limits_{i=1}^n (y_i - \hat{y}_i)^2}
\end{equation*}
% }
