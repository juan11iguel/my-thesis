...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/intro-modelling-gpr.png}
    ...
    \newline Source: Rasmussen \textit{et al.}~\cite{rasmussen_gaussian_2006}}
...
\begin{figure*}
    \centering
    \subfloat[\centering
    Feedforward]{{\includegraphics[width=0.24\linewidth]{figures/ann_neuron_type_simple_with_partial_legend.eps}
    }}%
    \qquad
    \subfloat[\centering
    Cascade-forward]{{\includegraphics[width=0.24\linewidth]{figures/ann_neuron_type_cascade_with_partial_legend.eps}
    }}%
    \qquad
    \subfloat[\centering
    Radial-basis]{{\includegraphics[width=0.24\linewidth]{figures/ann_neuron_type_radial_with_partial_legend.eps}
    }}%
