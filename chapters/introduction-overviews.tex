...
useful in many applications~\sidecite{sokolowski_principles_2011}: 
...
\begin{itemize}
    ...
    deteriorate the system, among other factors. Simulating a model enables the
    repeated observation of a system with just an associated computational cost. 
...
evaluations\sidenote{Here, ``unable'' refers to requiring an unfeasible number of
objective function evaluations, \ie, too much time.}.
