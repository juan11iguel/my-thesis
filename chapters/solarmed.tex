...
as solar thermal energy. As desalination becomes increasingly important to
address global freshwater scarcity, modern thermal desalination systems
---particularly low-temperature \gls{medLabel}--- offer a robust and
complementary pathway for brine concentration and resource recovery, especially
when coupled with waste-heat or renewable sources.\\
...
variable operating conditions is detailed in \refch{solarmed:std}, together to
its application to the experimental plant in a high-TBT experimental campaign.
The methodology for modelling and optimizing the operation of the system are
described in \refch{solarmed:modelling} and \refch{solarmed:optimization},
respectively.
...
\begin{figure}
    ...
    \caption[Global water stress map]{Global water stress map. \\[1ex]Source:
...
1.6 to 2.1 times higher than seawater, along with residual process chemicals
such as coagulants, antiscalants, and
desinfectants~\sidecite{panagopoulos_study_2022}. Its conventional disposal
...
aligns with the principles of a circular water economy. Through \gls{mldLabel}, it is possible to recover up to 95--100~\% of
...
Desalination refers to the set of processes that separate dissolved salts and
...
of their lower energy requirements and modular scalability. The main categories are:
...
\begin{itemize}
    ...
    properties, on operating conditions and on the membrane configuration.
...
focused on optimizing heat exchanger design, corrosion resistance, and
...
membranes exhibit much higher effective conductance than heat exchangers~\cite{bouma_metrics_2020},
...
valorization, thermal/chemical recovery). Recycling is technically feasible and
...
\begin{marginfigure}[-1.5cm]
    ...
    \caption[Desalination technologies used at plants worldwide in 2019]{Desalination technologies used at plants worldwide in 2019\\[1ex]Source:
...
using this technology in 2019, while 21~\% remained in using thermal
technologies (namely, \gls{medLabel} and
...
applications where \gls{roLabel} performance ---at its current status--- declines
sharply. The development of membrane distillation (\gls{mdLabel}) ---a low
temperature thermal separation process--- is an example of this shift.
...
\begin{marginfigure}[]
    ...
    produced]{\gls{ghgLabel}s emissions per cubic meter of freshwater
...
\begin{marginfigure}[]
    ...
    plants worldwide]{Desalination technologies coupled with renewable energy
    sources at plants worldwide. \\Source: Panagopoulos
    \etal~\cite{panagopoulos_environmental_2020}}
...
heat and cool greenhouses, and powers a desalination plant. The system annually
