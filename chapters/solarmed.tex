...
\begin{itemize}
    ...
    and membrane technologies\todo{LRoca: yo esto no lo veo. Vale que es una
    membrana, pero es un proceso térmico }. It operates on the principle of vapor-phase
    ...
    utilize low-grade or waste heat (<~80~$^\circ$C), tolerate very high
    salinity feeds (even near saturation), and achieve high rejection rates
    (>99.9~\%\todo{referencia para esto, cambiar o quitar}). Common configurations include Direct Contact \gls{mdLabel}
    ...
    \gls{mldLabel} systems, and solar-driven desalination.
\end{itemize}
...
of membrane distillation (\gls{mdLabel}) ---a hybrid thermal-membrane
process\todo{LRoca: hybrid?. Juanmi: Alba?}--- is an example of this shift.
