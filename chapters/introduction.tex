...
\myepigraphhead[500]{To live in a paradox and yet do the dishes.\\//\\Vivir en
una paradoja y aún así seguir fregando los platos.}{Exurb1a on
\href{https://www.youtube.com/watch?v=Jv79l1b-eoI}{Absurdism, How to Party at
the End of Meaning} // Absurdismo, cómo celebrar en el fin del sentido}
...
\begin{figure}
    ...
    \caption[Annual global mean temperature anomalies]{Annual global mean
    temperature anomalies relative to a pre-industrial (1850--1900) baseline.\\
    Source: State of the Global Climate. World Meteorological Organization
...
\begin{itemize}
    ...
    than doubled} in the last two decades~\sidecite[*-4]{geyer_production_2017}. Only
    a small fraction of this plastic is recycled, and even then, only a limited
    number of times\sidenote[][*-3]{As environmental engineer
...
renewables, are now turning towards cleaner technologies\sidenote[][*-5]{The
...
regressive agendas\sidenote[][*-3]{Two examples:\\\textbf{·} President Trump
...
even more concerning trend: \textit{open denialism}. 
...
Thus far, the prevailing trend points toward the latter.
...
\bigskip
\noindent \textbf{Open implementation and reproducibility}
...
appropriate~\sidecite{burgess_solar_2005} nor a standardized methodology for
