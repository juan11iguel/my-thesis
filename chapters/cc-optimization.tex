...
\labsec{cc:optimization:environment-water}
 Two sources of water are available, one of them, the cheaper one coming from a
 dam is limited in volume ($V_{avail,0}$). The cheaper source is prioritized
 until it is depleted, then the alternative source is used.
