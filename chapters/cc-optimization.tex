...
Two works dealing with a hybrid cooling system operation can be found in Rohani
...
Nonetheless, there remains significant potential for improved water management
...
\begin{itemize}
    ...
    a minimum, robustly satisfy the cooling demand.\sidenote{This is what
    \cite{rohani_optimization_2021} and \cite{golkar_determination_2019}
    achieve.}
\end{itemize}
