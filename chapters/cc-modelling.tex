...
el\todo{completar esta sección antes del domingo} criterio para elegir esas variable de entrada para construir la combinatoria
...
In this work, sample generation is carried out using a structured grid-search\todo{completar esta sección antes del domingo}
