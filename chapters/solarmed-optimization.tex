...
developed a Hybrid practical-Nonlinear Model Predictive Control (HPNMPC) scheme.
...
\begin{marginfigure}[-9.5cm]
    ...
    \caption[Decision tree resulting from the combinatorial nature of a MINLP problem]{Decision tree resulting from the combinatorial nature of the integer part of the optimization problem. Text in nodes represents system states.}
...
\begin{figure*}[htbp]
    ...
    \caption[Proposed n\gls{nlpLabel} methodology computation timeline]{Proposed n\gls{nlpLabel} methodology computation timeline.
    ...
    start. \texttt{(4)}~Operation plan shutdown evaluation and
...
promising candidates. If too aggressive pruning is applied, there is a risk of
