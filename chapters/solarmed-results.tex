...
\begin{figure*}
    ...
    \subfloat[Algorithms fitness evolution \hspace{1ex} \usebox\captionqrleft]{%
        \includegraphics[width=0.50\linewidth]{figures/solarmed-operation_plan-algo_comparison.png}
    }
    \hspace{0.03\linewidth}
    \subfloat[Startup-problems fitness evolution \hspace{1ex} \usebox\captionqrright]{%
        \includegraphics[width=0.42\linewidth]{figures/solarmed-operation_plan-startup-problems_fitness_comparison.png}
    }
...
\begin{figure*}
    ...
    \makebox[\textwidth][c]{\includegraphics[angle=90,width=0.7\paperwidth]{figures/solarmed-result.png}}%
    \caption{A rotated figure \hspace{1ex}\usebox\captionqr}
\end{figure*}%
\restoregeometry
}
