...
I~\sidecite{alarcon-padilla_application_2007,blanco_aquasol_2011} built upon
...
\begin{figure*}
    \centering
    \subfloat[\centering Solar field]{{\includegraphics[width=0.55\linewidth]{figures/solarmed-solar-field.jpg}}}%
    \hspace{0.01\linewidth}
    \subfloat[\centering Thermal storage]{{\includegraphics[width=0.413\linewidth]{figures/solarmed-thermal-storage.jpg}}}%
...
is shown at Table \reftab{solarmed:facility:specifications}.
...
\reftab{solarmed:modelling:med-data-range}. 
...
\reftab{solarmed:facility:instrumentation} and the placement in the system can
be seen in \reffig{solarmed:facility:pid}. \gls{pt100Label}
