...
\begin{figure*}
    \centering
    \subfloat[\centering \gls{lcoeLabel} evolution. Source: \gls{irenaLabel}~\cite{irena_renewable_2025}]{{\includegraphics[width=0.48\linewidth]{renewables-lcoe-evolution-irena-2025.png}}}%
    \hspace{0.01\linewidth}
    \subfloat[\centering Estimated future share of new renewable generation.
    Source: Lilliestam~\etal~\cite{lilliestam_midterm_2021}]{{\includegraphics[width=0.48\linewidth]{renewables-capacity-evolution-schoniger-2022.png}}}%
...
\begin{figure*}
    \centering
    \subfloat[\centering Solar resource map. Source: \href{https://solargis.com/}{Solar resource map\textcopyright2021 Solargis}]{{\includegraphics[width=0.52\linewidth]{cc-intro-ghi-map.png}}}%
    \hspace{0.1cm}
...
Andras~\etal, Heller systems require approximately the same
...
(Sau~\etal, 2016). It should be noted that many of these analysis were made for
