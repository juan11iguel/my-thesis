...
\marginannotation[]{}{In all models, it has been assumed that model parameters
...
in Ampuño et al.~\sidecite[*-2]{ampuno_modeling_2018} is used to model the solar
...
delay is
modelled~\sidecite[*-10]{ampuno_apparent_2019}\sidenote[][*-5]{Transport delays
...
\begin{figure}
    ...
    \caption{Solar field flow rate for different pump configurations and their associated power consumption.\\[1ex] \usebox\captionqr}
...
\begin{figure*}[h!]
    ...
    \caption[]{Solar field model calibration and validation tests. The colors in
    the validation plot represent the different loops (not available in the
    calibration data)\hfill
...
the logical \texttt{AND} operator.}
