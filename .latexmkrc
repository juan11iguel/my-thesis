...
# JM: This is from https://github.com/alexpovel/latex-cookbook/
# Uses lualatex but sadly does not produce the same output as the one from 
# the template (github.com/fmarotta/kaobook)
...
# sub makeglossaries {
#   my $basename = shift;
#   return system("makeglossaries $basename");
# }