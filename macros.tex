...
% Color definitions for margin citations
\ifprintedversion
    % Darker gray for printed B&W version (Gray!30)
    \definecolor{margincitecolor}{RGB}{77,77,77}
    \definecolor{linkcolor}{RGB}{77,77,77}
\else
    % Light gray for digital version (Gray!90)
    \definecolor{margincitecolor}{RGB}{230,230,230}
    % Green for digital version
