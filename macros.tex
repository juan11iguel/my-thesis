...
\ifprintedversion
    ...
    \colorlet{linkcolor}{black!50!Gray}
    ...
    \colorlet{nomgroupcolor}{black}  % Black text for nomenclature groups (same as body text) Is it working? 
\else
    % Colors for digital version
    \colorlet{margincitecolor}{Gray!90}
    \colorlet{linkcolor}{OliveGreen}
    \colorlet{nomgroupcolor}{OliveGreen}
\fi
